//dot2 Akai Fire control code v 1.1.90 by ArtGateOne
    ...
    if (msg.controller == 16 || msg.controller == 17 || msg.controller == 18 || msg.controller == 19) {//Encoder rotate
        ...
        if (encoder_mode == 0) {// Speed masters
            ...
            if (msg.controller == 16) {//User2 Encoder 1
                if (msg.value < 60) {
                    client.send('{"command":"Feature $feature.1 At + ' + (msg.value) + '","session":' + session + ',"requestType":"command","maxRequests":0}');
                } else {
                    client.send('{"command":"Feature $feature.1 At + ' + (msg.value - 128) + '","session":' + session + ',"requestType":"command","maxRequests":0}');
                }
            }

            else if (msg.controller == 17) {//User2 Encoder 2
                if (msg.value < 60) {
                    client.send('{"command":"Feature $feature.2 At + ' + (msg.value) + '","session":' + session + ',"requestType":"command","maxRequests":0}');
                } else {
                    client.send('{"command":"Feature $feature.2 At + ' + (msg.value - 128) + '","session":' + session + ',"requestType":"command","maxRequests":0}');
                }
            }

            else if (msg.controller == 18) {//User2 Encoder 3
                if (msg.value < 60) {
                    client.send('{"command":"Feature $feature.3 At + ' + (msg.value) + '","session":' + session + ',"requestType":"command","maxRequests":0}');
                } else {
                ...
                if (msg.value < 60) {
                    ...
                    client.send('{"command":"Feature $feature.4 At + ' + (msg.value - 128) + '","session":' + session + ',"requestType":"command","maxRequests":0}');
                }
            }
